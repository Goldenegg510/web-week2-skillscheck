...
// Code Here
let doubled = myNumbers.map(function(num,index,arr){
	return num * 2
})
//////////////////PROBLEM 15////////////////////
...
// Code Here
let filtered = myNumbers.filter(function(num, index, arr){
	return num > 100
})
//////////////////PROBLEM 16////////////////////
...
// Code Here
let total = myNumbers.reduce(function(total, current, index, arr){
...
// Code Here
let myNumbersIndex = []
myNumbers.forEach(function(value, index, arr){
...
// Code Here
let enemies = people.filter(function(value, index, arr){
	return !value.friend
})
//////////////////PROBLEM 20////////////////////
...
// Code Here
let totallyAwesome = people.reduce(function(total, current, index, arr){
	return total + current.awesomeLevel
}, 0)
